...
import com.ruslangrigoriev.rickandmorty.data.local.coverters.EpisodeConverter
...
@TypeConverters(EpisodeConverter::class, LocationConverter::class, OriginConverter::class)
